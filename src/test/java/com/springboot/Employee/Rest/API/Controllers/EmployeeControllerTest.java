...
public class EmployeeControllerTest {
    ...
    public void getEmployeesTest() throws Exception {
        ...
        final RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/employees").accept(MediaType.APPLICATION_JSON);
    ...
    public void getEmployeeByIdTest() throws Exception {
        ...
        final RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/employees/1").accept(MediaType.APPLICATION_JSON);
        final MvcResult result = mockMvc.perform(requestBuilder).andReturn();
    ...
    public void addEmployeeTest() throws Exception {
        ...
        final RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/employees")
    ...
    public void updateEmployeeTest() throws Exception {
        Mockito.when(employeeService.save(Mockito.any(Employee.class))).thenReturn(mockEmployee);
        final RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/employees")
                .accept(MediaType.APPLICATION_JSON)
                .content(exampleEmployee)
                .contentType(MediaType.APPLICATION_JSON);
        final MvcResult result = mockMvc.perform(requestBuilder).andReturn();
...
//        JSONAssert.assertEquals(exampleEmployee,result.getResponse().getContentAsString(),false);
    ...
    public void deleteEmployeeTest() throws Exception {
        ...
        final RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/api/employees/0");
        final MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        System.out.println(result.getResponse().getContentAsString());
